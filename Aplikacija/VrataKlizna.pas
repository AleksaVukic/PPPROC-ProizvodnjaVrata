...
var
  frmKliznaVrata: TfrmKliznaVrata;
...
procedure TfrmKliznaVrata.BackClick(Sender: TObject);
begin
frmNormiranje.show;
self.hide;
end;

procedure TfrmKliznaVrata.RefreshClick(Sender: TObject);
begin
var
  MyQuery: TFDQuery;
var
...
var
  ...
  begin
    ...
    try
      ...
      MyQuery.SQL.Text := 'SELECT * FROM SifarnikProizvoda WHERE Naziv = "Klizna vrata"';
      MyQuery.Open;
