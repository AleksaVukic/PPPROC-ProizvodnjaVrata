...
procedure TfrmDvokrilnaVrata.BackClick(Sender: TObject);
begin
frmNormiranje.show;
self.hide;
end;

procedure TfrmDvokrilnaVrata.RefreshClick(Sender: TObject);
begin
var
  MyQuery: TFDQuery;
var
...
var
  ...
  begin
    ...
    try
      ...
      MyQuery.SQL.Text := 'SELECT * FROM SifarnikProizvoda WHERE Naziv = "Dvokrilna vrata"';
      MyQuery.Open;
