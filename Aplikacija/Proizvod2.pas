...
procedure TfrmProizvod2.RoundRect12Click(Sender: TObject);
var
...
procedure TfrmProizvod2.RoundRect13Click(Sender: TObject);
var
RGBColor1: TAlphaColor;
var
RGBColor2: TAlphaColor;
...
procedure TfrmProizvod2.RoundRect1Click(Sender: TObject);
begin
frmProdaja.show;
self.hide;
end;
