...
procedure TfrmProizvod4.RoundRect12Click(Sender: TObject);
var
...
procedure TfrmProizvod4.RoundRect13Click(Sender: TObject);
var
RGBColor1: TAlphaColor;
var
RGBColor2: TAlphaColor;
...
procedure TfrmProizvod4.RoundRect1Click(Sender: TObject);
begin
frmProdaja.show;
self.hide;
end;
