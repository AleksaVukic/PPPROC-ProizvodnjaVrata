...
procedure TfrmHarmonikaVrata.BackClick(Sender: TObject);
begin
frmNormiranje.show;
self.hide;
end;

procedure TfrmHarmonikaVrata.RefreshClick(Sender: TObject);
begin
var
  MyQuery: TFDQuery;
var
...
var
  ...
  begin
    ...
    try
      ...
      MyQuery.SQL.Text := 'SELECT * FROM SifarnikProizvoda WHERE Naziv = "Harmonika vrata"';
      MyQuery.Open;
