...
CREATE TABLE IF NOT EXISTS "Nalog" (
	"NalogID"	INTEGER NOT NULL UNIQUE,
	"Ime"	TEXT,
	"Prezime"	TEXT,
	"BrTelefona"	TEXT,
	"Email"	TEXT UNIQUE,
...
INSERT INTO "Nalog" VALUES (1,'Aleksa','Vukic','0611889604','aleksavukic.lttm@gmail.com','test123','KUPAC');
INSERT INTO "Nalog" VALUES (2,'Admin','Admin','/','admin@gmail.com','admin','KUPAC');
INSERT INTO "Nalog" VALUES (3,'Ognjen','Stepanovic','/','ognjenstepanovic@gmail.com','1234','KUPAC');
